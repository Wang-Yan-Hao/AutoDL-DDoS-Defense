...
log_file = os.path.join(script_dir, f'./{current_file_name}_3dyas.log')
logging.basicConfig(
    level=logging.DEBUG,
    handlers=[
...
api = TabularClassificationTask(
    temporary_directory= os.path.join(script_dir, './tmp_3days/autoPyTorch_example_tmp'),
    output_directory= os.path.join(script_dir, './tmp_3days/autoPyTorch_example_out'),
