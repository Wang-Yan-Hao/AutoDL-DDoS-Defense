...
output_folder = 'data/evaluation_data/output/'
if not os.path.exists(output_folder):
    os.mkdir(output_folder)

# Process the training dataset
training_output_csv_path = 'data/evaluation_data/output/01-12_five_percent.csv'
training_selected_rows = process_dataset(training_dataset_path, training_output_csv_path)

# Process the testing dataset
testing_output_csv_path = 'data/evaluation_data/output/03-11_five_percent.csv'
