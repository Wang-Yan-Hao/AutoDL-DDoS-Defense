...
cols = list(pd.read_csv('data/searching_data/output/03-11_five_percent.csv', nrows =1))
...
print('Training Day')
handle_func('data/searching_data/output/01-12_five_percent.csv', 'data/searching_data/output/01-12_five_percent_clean.csv')
print('Testing Day')
handle_func('data/searching_data/output/03-11_five_percent.csv', 'data/searching_data/output/03-11_five_percent_clean.csv')
