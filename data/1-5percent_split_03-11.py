...
Ten_percent_testing_dict = {'csv_path': '03-11-output.csv'}
...
first_csv_file = Testing_dataset_files_list[0]
header_df = pd.read_csv(first_csv_file, nrows=0, dtype={'SimillarHTTP': str})
dfs = []

for csv_path in Testing_dataset_files_list:
...
Ten_percent_testing_dict
selected_df.to_csv('./seed=12=03-11-5-percent.csv', index=False)

for key in Ten_percent_testing_dict:
    print(f"{key} 這個類型的封包擁有 {Ten_percent_testing_dict[key]} 這麼多個")
