...
class AutoMLSMBO(object):
    ...
    def run_smbo(self, func: Optional[Callable] = None
        ...
        # smac.optimize()
        from autoPyTorch.optimizer import pb2
        pb2.pb2_optimize(self.X_train, self.y_train, self.X_test, self.y_test, self.dataset_properties, self.include, self.exclude, scenario_dict, ta, ta_kwargs, self.n_jobs, self.initial_configurations)
